...
export const EditForm = ({ isOpen, setIsOpen, id, token }) => {
  ...
  if (!isLoading && data) {
    ...
    newData.kategori = category[data.category];
    newData.kode = data.courseCode;
    newData.telegram = data.telegram;
    newData.intro = data.introVideo;
    newData.author = data.author;
    newData.tipe = data.isPremium;
    ...
    newData.onboarding = data.onboarding;
  }
  const {
    data: categories,
