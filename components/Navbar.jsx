		...
		<div className='bg-secret-background sticky top-0 z-20 shadow-2xl black100/40'>
			<nav className='container flex items-center justify-between h-20 px-2 mx-auto'>
				<div className='flex items-center space-x-4'>
					<Link href='/' className='md:flex items-center sm:space-x-2'>
						<div className='flex sm:flex-row sm:gap-2 flex-col items-center'>
							<BiBrain className='text-white bg-secret-pink rounded-full text-5xl p-2' />
							<div className='flex'>
								<h1 className='md:text-2xl text-lg text-secret-text flex items-center font-bold'>SkillHUB</h1>
...
<<<<<<< HEAD
            ...
            <>
						...
						<div className='flex md:flex-row sm:flex-row flex-col'>
							<span className='font-bold md:mr-4 sm:mr-4 text-sm'>HI, {user.name}</span>
