...
export default function HomePageButton({name, categoryId, handleChange, queryCategory}){
    ...
    <input
        ...
        className={`rounded-2xl px-3 py-1 font-bold shadow-xl  hover:-translate-y-1 duration-300 ${IsActive ? 'bg-secret-darkblue text-white' : 'bg-secret-cyan text-secret-text3'} text-sm md:text-base`}
        value={name}
    />
