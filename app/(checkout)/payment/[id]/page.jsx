...
export default function KelasPembayaran () {
  ...
  return (
    <div>
      ...
      <div className="flex md:flex-col lg:flex-row xl:flex-row 2xl:flex-row flex-col md:px-[100px] xl:px-[215px] 2xl:px-[215px] h-[600px] mt-10  justify-center mx-auto gap-6">
        {/* KIRI */}
        {/* kotak Pembayaran */}
